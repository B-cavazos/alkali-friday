...
if ( ! function_exists( 'alkali_underscores_setup' ) ) :
	/**
	 ...
	 */
	function alkali_underscores_setup() {
		/*
  ...
  function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
  {
    ...
    $output .= apply_filters('walker_nav_menu_start_el', $item_output, $item, $depth, $args);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'alkali_underscores_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'alkali_underscores_setup' );
 ...
 */
function alkali_underscores_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'alkali_underscores_content_width', 640 );
}
add_action( 'after_setup_theme', 'alkali_underscores_content_width', 0 );
 ...
 */
function alkali_underscores_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'alkali_underscores_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function alkali_underscores_scripts() {
	...
	//UNDERSCORES' DEFAULT STYLE ENQUEUE
	...
	//ENQUEUE BOOSTRAP JS
	wp_enqueue_script( 'alkali-friday-bootstrap-js', get_template_directory_uri() . './js/bootstrap.min.js', array(), 5.0, true );

	//ENQUEUE UNDERSCORES DEFAULT JS
...
add_action( 'wp_enqueue_scripts', 'alkali_underscores_scripts' );
